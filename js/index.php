...
<label>Pateikiama info:</label><input type="text" name="info" id="infoc">
...
<p>JS</p>
<form action="" method="post">
<label>Pateikiama info:</label><input type="text" name="info" id="infojs">
<button type="button" id="button">Pateikti Info</button>
</form>
